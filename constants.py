...
PIA_COUNTRIES = [
    ...
    {"id": "djibouti", "name": "Djibouti", "region": "East Africa"},
    {"id": "equatorial_guinea", "name": "Equatorial Guinea", "region": "Central Africa"},
    ...
    {"id": "senegal", "name": "Senegal", "region": "West Africa"},
    ...
    {"id": "togo", "name": "Togo", "region": "West Africa"},
